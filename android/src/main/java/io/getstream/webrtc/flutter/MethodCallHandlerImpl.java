...
import io.getstream.webrtc.DtmfSender;
...
import io.getstream.webrtc.PeerConnection.BundlePolicy;
import io.getstream.webrtc.PeerConnection.CandidateNetworkPolicy;
import io.getstream.webrtc.PeerConnection.ContinualGatheringPolicy;
import io.getstream.webrtc.PeerConnection.IceServer;
import io.getstream.webrtc.PeerConnection.IceServer.Builder;
import io.getstream.webrtc.PeerConnection.IceTransportsType;
import io.getstream.webrtc.PeerConnection.KeyType;
import io.getstream.webrtc.PeerConnection.RTCConfiguration;
import io.getstream.webrtc.PeerConnection.RtcpMuxPolicy;
import io.getstream.webrtc.PeerConnection.SdpSemantics;
import io.getstream.webrtc.PeerConnection.TcpCandidatePolicy;
import io.getstream.webrtc.PeerConnectionFactory;
import io.getstream.webrtc.PeerConnectionFactory.InitializationOptions;
import io.getstream.webrtc.PeerConnectionFactory.Options;
...
import io.getstream.webrtc.SessionDescription.Type;
...
import io.getstream.webrtc.video.CustomVideoDecoderFactory;
import io.getstream.webrtc.video.CustomVideoEncoderFactory;
...
public class MethodCallHandlerImpl implements MethodCallHandler, StateProvider {
  ...
  public void onMethodCall(MethodCall call, @NonNull Result notSafeResult) {
    ...
    switch (call.method) {
      ...
      case "setLogSeverity": {
        // now it's possible to setup logSeverity only via
        // PeerConnectionFactory.initialize method
